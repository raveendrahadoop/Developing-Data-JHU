  ...
  sidebarLayout(
    sidebarPanel(
      ...
      sliderInput("range",
                  ...
                  value = c(1992, 2006), 
                  format = "0000"), 
      helpText(p("Move the scroll bar to adjust the period of time displayed."), p("Plot Created on 03 Mar 2016 by Ravi"), img(src="https://raw.githubusercontent.com/pachamaltese/Developing-Data-Products/master/project/elder-population-in-chile/logo.jpg"), p("This plot was created for JHU's Developing Data Products MOOC."))
    ),
